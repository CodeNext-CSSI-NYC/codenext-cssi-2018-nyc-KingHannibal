...
let howLong = parseInt(readline.question("What number would you like the multiplication-table go up to?? : "));
let row;
...
for(fix=0;fix<table.length;fix++){
	console.log(table[fix]);
}
